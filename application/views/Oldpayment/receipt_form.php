                ...
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open('Cpayment/transection_entry', array('class' => 'form-vertical','id' => 'validate'))?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control datepicker" name ="date" id="first_name" type="text" placeholder="Date"  required="" value="<?php echo date('d-m-Y') ?>">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="" id="PaymentContainer1"> 
                                ...
                                <div class="col-sm-4">
                                <input class="none form-control " name ="pay_amount" id="payment" class="none" type="number" placeholder="Payment Amount" ></div>
                            </div>
                            ...
                            <div class="" id="PaymentContainer2">
                                ...
                                <div class="col-sm-4">
                                    <input class="none form-control " name ="amount" id="receipt" class="none" type="number" placeholder="Recipt Amount">
                                </div>
                            </div>
                        </div>
...
function myFunction() {
    ...
    if(x==1){x='Supplier'}
        if(x==2){x='Customer'}
             if(x==3){x='Office'}
                 if(x==4){x='Loan'}
    document.getElementById("demo").innerHTML = "Select: " + x +" Id";
}
</script>