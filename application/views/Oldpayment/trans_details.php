	...
	<section class="content-header">
	    <div class="header-title">
	        ...
	        <ol class="breadcrumb">
	            ...
	            <li><a href="<?php echo base_url('Cpayment')?>"><?php echo display('transaction') ?></a></li>
	    ...
	    <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cpayment')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i><?php echo display('add_payment') ?></a>
		                    ...
		                    <table id="dataTableExample2" class="datatable table table-striped table-hover">
		                        <thead>
									<tr>
										...
										<th><?php echo display('total_transaction') ?></th>
