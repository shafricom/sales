                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><?php echo display('transaction')?></label>
                            ...
                            <div class="form-group row">
                                ...
                                <label for="first_name" class="col-sm-2 col-form-label"><?php echo display('category')?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="transection_category" id="selId" class="form-control" class="form-control">
                                       
                                    <?php foreach($category_list as $values){  ?>
                                            <option value="<?php echo $values['parent_id']; ?>"><?php echo $values['account_name']; ?></option>
                                    <?php } ?>

                                     <?php  foreach($category_selected as $values){ ?>
                           ...
                           <div class="form-group row" id="PaymentContainer1"> 
                                <label for="first_name" class="col-sm-2 col-form-label"><?php echo display('ammount')?></label>
                                <div class="col-sm-4">
                                    <input class="none form-control " name ="pay_amount" id="school" class="none" type="number" placeholder="<?php echo display('ammount')?>" value="{pay_amount}" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row" id="PaymentContainer2">
                                <label for="first_name" class="col-sm-2 col-form-label"><?php echo display('ammount')?></label>
                                <div class="col-sm-4">
                                    <input class="none form-control " name ="amount" id="school" class="none" type="number" placeholder="<?php echo display('ammount')?>" value="{amount}">
                                </div>
                            </div>
