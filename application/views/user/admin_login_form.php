...
<div class="container-center">
  ...
  width: 50%;
	...
	<div>
	<img src="../header_logo.png" class="center"><br/>
	</div>
    <div class="panel panel-bd">
        <div class="panel-heading">
            <div class="view-header">
                ...
                <div class="header-title">
                    ...
                    <small><strong><?php echo display('please_enter_your_login_informationx') ?></strong></small>
                </div>
            </div>
        </div>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <span class="help-block small"><?php echo display('your_unique_emailx') ?></span>
            </div>
            <div class="form-group">
                ...
                <span class="help-block small"><?php echo display('your_strong_passwordx') ?></span>
            </div>
            ...
            <div>
                ...
                <button class="btn btn-success"><a href ="../xinstall" >REGISTER AS NEW USER</a></button>
            </div>
            <?php echo form_close() ?>
        </div>
