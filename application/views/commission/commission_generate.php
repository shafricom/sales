		                    ...
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
		                        ...
		                        ?>
									...
									<tr>
										...
										<td>{product_model}</td>
										<td>{quantity}</td>
										<td style="text-align: center;"><?php echo (($position==0)?"$currency {commission}":"{commission} $currency") ?></td>
										<td style="text-align: center;"><?php echo (($position==0)?"$currency {total_commission_rate}":"{total_commission_rate} $currency") ?></td>
									</tr>
								{/product_info}
								<?php
								}
		                        ...
		                        <tfoot>
									<tr>
										...
										<td><b></b></td>
										<td style="text-align: center;"><b><?php echo (($position==0)?"$currency {subTotalComs}":"{subTotalComs} $currency") ?></b></td>
									</tr>
								</tfoot>
								<?php
								}
