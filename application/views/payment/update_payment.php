            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        ...
                        <!-- </div> -->
                        <?php echo form_open('Cpayment/payment_update', array('class' => 'form-vertical', 'name' => 'edit_form', 'id' => 'validate')) ?>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="supplier_id" id="test1" class="hidid form" style="width: 290px; height: 35px">
                                        ...
                                        foreach ($supplier as $values) {
                                            if ($relation_id == $values['supplier_id']) {
                                                ?>
                                                <option selected value="<?php echo $values['supplier_id']; ?>"><?php echo $values['supplier_name']; ?></option>
                                            <?php } else { ?>
...
//                                        foreach ($supplier_seleced as $values) {
                                    ...
                                    <div id="test4" class="hidid"  style="width: 100%; height: 35px">
                                        <?php // echo '<pre>'; print_r($loan_list); echo '</pre>';die();    ?>
                                        <select name="loan_id" id="loan_id" class="form-control loanSelection" data-placeholder="-- select one --">
                                            <option value=""></option>
                                            <?php
                                            foreach ($loan_list as $loan) {
                                                if ($relation_id == $loan['person_id']) {
                                                    ?>
                                                    <option selected value="<?php echo $loan['person_id']; ?>"><?php echo $loan['person_name']; ?></option>
                                                <?php } else { ?>
                                                    <option value="<?php echo $loan['person_id']; ?>"><?php echo $loan['person_name']; ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
...
//                                        };
                                    ...
                                    <select name="office" id="test3" class="hidid " style="width: 100%; height: 35px">
                                        ...
                                        foreach ($account_list as $values) {
                                            if ($relation_id == $values['account_id']) {
                                                ?>
                                                <option selected value="<?php echo $values['account_id']; ?>"><?php echo $values['account_name']; ?></option>
                                            <?php } else { ?>
...
//        document.forms['edit_form'].elements['loan_id'].value = "<?php
//                        if ($transection_category == 4) {
//                            echo $relation_id;
//                        }
                        ?>";
