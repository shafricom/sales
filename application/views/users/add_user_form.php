            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group row">
                            <label for="user_type" class="col-sm-3 col-form-label">Gender<i class="text-danger">*</i></label>
                            <div class="col-sm-6">
						...
						<div class="form-group row">
                            <label for="last_name" class="col-sm-3 col-form-label">Phone <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="2" class="form-control" name="last_name" id="last_name" placeholder="Phone Number" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="user_type" id="user_type" tabindex="5">
								    ...
								    <option value="3"><?php echo display('user3') ?></option>
								    <option value="4"><?php echo display('user4') ?></option>
								  </select>
                            </div>
                        </div>
