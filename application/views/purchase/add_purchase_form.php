                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cpurchase/insert_purchase',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="adress" class="col-sm-4 col-form-label">Seller's Name
                                    </label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control" tabindex="4" id="adress" name="purchase_details" placeholder=" Seller Name" rows="1"></textarea>
                                    </div>
                                </div> 
                            </div>
                        </div>
