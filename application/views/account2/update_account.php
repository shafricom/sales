                  ...
                  <?php echo form_open('Account_Controller/account_update',array('class' => 'form-vertical', 'id' => 'add_account'))?>
                    <div class="panel-body">
                       ...
                       <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="parent_id" class="form-control" id="parent_account" data-placeholder="-- select one --"> 
                                    <option value=""></option>
                                    <option value="1" <?php if ($parent_id == 1) {echo "selected"; }?>><?php echo display('supplier')?></option>
                                    <option value="2" <?php if ($parent_id == 2) {echo "selected"; }?>><?php echo display('customer')?> </option>
