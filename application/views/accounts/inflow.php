        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Caccounts/inflow_entry',array('class' => 'form-vertical','id' => 'inflow_entry' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                               <select name="account_table" class="form-control" id="account_table" required="">
                                <?php if ($accounts) { ?>
                                    {accounts}
                       	...
                       	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
								<input type="number" class="form-control" id="amount" name="amount" required placeholder="<?php echo display('ammount') ?>" required />
                            </div>
                        </div>
