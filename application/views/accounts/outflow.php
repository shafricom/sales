            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                  	...
                  	<?php echo form_open_multipart('Caccounts/outflow_entry',array('class' => 'form-vertical','id' => 'outflow_entry' ))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="transection_date" data-date-format="yyyy-mm-dd" value="<?php echo $today; ?>" id="payment_date"  class="datepicker form-control" required/>
                            </div>
                        </div>
					    ...
					    <div class="form-group row" id="payment_from_2">
					        ...
					        <div class="col-sm-6">
						       	<input type="text"  name="customer_name_others" class="form-control" placeholder='Type Payee Name' id="customer_name_others" required="" />
					        </div>
					    ...
					    <div class="form-group row">
					        ...
					        <div class="col-sm-6">
								<select onchange="bank_info_show(this)" name="payment_type" id="payment_type" class="form-control" required="">
					    ...
					    <div id="bank_info_hide">
					    	<div class="form-group row">
						        ...
						        <div class="col-sm-6">
							        <input type="test" id="cheque_or_pay_order_no" class="form-control"  name="cheque_no" placeholder="<?php echo display('cheque_or_pay_order_no') ?>" required/>
						        </div>
						    </div>
						    <div class="form-group row">
						        <label for="date" class="col-sm-3 col-form-label"><?php echo display('date') ?> <i class="text-danger">*</i></label>
						        <div class="col-sm-6">
							        <input type="text" name="cheque_mature_date" data-date-format="yyyy-mm-dd" value="<?php echo $today; ?>" id="date"  class="datepicker form-control" required/>
						        </div>
						    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                               	<select name="account_table" id="payment_account" class="form-control" required="">
                                <?php if ($accounts) { ?>
				                    {accounts}
                       	...
                       	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
								<input type="number" id="amount" name="amount" required class="form-control" placeholder="<?php echo display('ammount') ?>" required/>
                            </div>
                        </div>
